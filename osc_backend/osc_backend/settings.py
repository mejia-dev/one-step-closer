"""
Django settings for osc_backend project.
...
SECRET_KEY = 'django-insecure-y77j-yuzf*&421a6kkzc#73#(hc4y4z^+c$bqfp193zo7^=gf3'
...
WSGI_APPLICATION = 'osc_backend.wsgi.application'
